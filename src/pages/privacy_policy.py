...
def privacy_policy_page():
    ...
    - Toplanan veriler: Kullanıcı adı, şeifre, mail adresi ve telefon numarası.
    ...
    ### İletişim
    Gizlilik politikamızla ilgili sorularınız için bize 'Geri Bildirim Gönderin' sayfasından ulaşabilirsiniz.
    """)
...
def terms_of_service_page():
    ...
    ### İçerik Politikası
    - Kafe incelemeleri ve yorumlar hakaret, tehdit veya uygunsuz içerik içeremez.
